...
FROM ${CI_DEPENDENCY_PROXY_GROUP_IMAGE_PREFIX}/renovate/renovate:37.90.1
USER 0
COPY --from=base /app/renovate-0.0.0-semantic-release.tgz /renovate-0.0.0-semantic-release.tgz
RUN npm install --prefix /opt/containerbase/tools/renovate/37.90.1/ /renovate-0.0.0-semantic-release.tgz
